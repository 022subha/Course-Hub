  ...
  const handleDelete = async (e) => {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://course-hub-api.vercel.app/api/course/delete-lecture?courseId=${courseId}&lectureId=${item._id}`,
  ...
  const getCourseDetails = async () => {
    try {
      const response = await axios.get(
        `https://course-hub-api.vercel.app/api/course/get-all-lectures/${course._id}`,
        { headers: { Authorization: "Bearer " + Cookies.get("token") } }
      );
  ...
  const addLecture = async (e, id) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://course-hub-api.vercel.app/api/course/add-lecture/${id}`,
        bodyContent,
        { headers: { Authorization: "Bearer " + Cookies.get("token") } }
      );
